...
$proco = $bdd->query("SELECT * FROM produits WHERE category = 1");
...
<body>
	...
	<?php ?>
				...
				?>
				  ...
				  {
				  ?>
					<form method="POST" action="iserie.php">
...
<!--
	https://www.ldlc.com/fr-be/fiche/PB00271922.php
-->
<footer>
